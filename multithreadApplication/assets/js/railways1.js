				...
				$(".division").on("click", function () {
					...
					$.ajax(settings).done(function (response) {
						...
						$(".category").on("click", function () {
							...
							CategoryName = $(this).find("label").html();
							...
							$.ajax(settings).done(function (response) {
								...
								$(".subcategory").on("click", function () {
									...
									$("#select-project-tab span")
										...
										form.append("zone", ZoneName);
										form.append("zone_id", Zone);
										form.append("division", Division);
										form.append("project_category", CategoryName);
										form.append("project_category_id", Category);
