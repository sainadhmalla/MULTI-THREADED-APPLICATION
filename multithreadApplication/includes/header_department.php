    ...
    <main role="main" class="container-fluid">
        <header class="home-page">
            <nav class="navbar navbar-light">
               ...
               <!-- <li class="post-internship-link"><a href="project.php" class="btn btn-sm btn-link">Dashboard</a></li> -->
                        <li class="post-internship-link"><a href="project.php" class="btn btn-sm btn-link">Project Management</a></li>
                        <li class="post-internship-link"><a href="interns.php" class="btn btn-sm btn-link">Applicant Management</a></li>
