        ...
        <header class="home-page">
            <nav class="navbar navbar-light">
                ...
                <div id="main-menu" class="header-links-wrap collapse">
                    ...
                    <li class="post-internship-link"><a href="railway_approval.php" class="btn btn-sm btn-link">Approval Management</a></li>
                        <li class="post-internship-link"><a href="project.php" class="btn btn-sm btn-link">Project Management</a></li>
                        <li class="post-internship-link"><a href="project.php" class="btn btn-sm btn-link">Project Approval</a></li>
                        <li class="post-internship-link"><a href="selected-interns.php" class="btn btn-sm btn-link">Dashboard</a></li>
                        <li class="post-internship-link"><a href="logout.php" class="btn btn-sm btn-link">Logout</a></li>
                    </ul>
                </div>
                </div>
            </nav>
