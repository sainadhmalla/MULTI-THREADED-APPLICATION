...
<head>
    ...
    <link href="./assets/css/style.1c48d001a3f8a2fd1816.css" rel="stylesheet">
            ...
            <nav class="navbar navbar-light">
                ...
                <div id="main-menu" class="header-links-wrap collapse">
                    <ul class="header-links">
                        <li class="post-internship-link"><a href="project.php" class="btn btn-sm btn-link">Add Project</a></li>
                        <li class="post-internship-link"><a href="railway_approval.php" class="btn btn-sm btn-link">Division/Workshop Approval</a></li>
                        <li class="post-internship-link"><a href="interns.php" class="btn btn-sm btn-link">Approval Management</a></li>
                        <li class="post-internship-link"><a href="selected-interns.php" class="btn btn-sm btn-link">Selected Interns</a>
