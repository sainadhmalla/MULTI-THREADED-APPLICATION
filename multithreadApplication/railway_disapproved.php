...
<section class="m-4">
    <div id="to_be_approved">
        ...
        $sql = "SELECT * FROM railways_register where railway_state_status = '2' and railway_organisation = 'Division' and railway_zone = '$zone'";
        }
        ...
        $sql = "SELECT * FROM railways_register where railway_state_status = '2' and railway_zone = '$zone'and railway_organisation = 'Department' and railway_organization='$division'";
        }
        else{
            $sql = "SELECT * FROM railways_register where railway_state_status = '2' and railway_organisation = 'Zone'";  
        }
