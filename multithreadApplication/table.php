                ...
                <div class="col">
                    <div class="register-section">
                        ...
                        <div class="tab-content category-tab-content" id="register-tabContent">
                            ...
                            <!-- /Step1 -->
                            <!-- Step 2 -->
                            <div class="tab-pane" id="form-step2" role="tabpanel"
                                aria-labelledby="form-step2-tab">
                                <div class="container">
                                    <div class="row">
                                        <div class="container mt-4">
                                            <form id="form2" class="text-center">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-4 col-8 form-group offset-md-8">
                                                        <label for="image-file">Upload an image less than 2MB</label>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6">
                                                        <label for="corr-address">Correspondence Address(in Block
                                                            letters)</label>
                                                        <textarea id="corr-address" class="form-control"
                                                            rows="3"></textarea>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="per-address">Permanent Address(in Block
                                                            letters)</label>
                                                        <textarea id="per-address" class="form-control"
                                                            rows="3"></textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="corr-mobno">Mobile NO.</label>
                                                        <input type="number" name="corr-mobno" class="form-control"
                                                            id="corr-mobno">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="per-mobno">Mobile NO.</label>
                                                        <input type="number" name="per-mobno" class="form-control"
                                                            id="per-mobno">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-md-6 ">
                                                        ...
                                                        <input type="date" width="25%" name="dob" class="form-control"
                                                            id="dob">
                                                    </div>
                                                    <div class="col-md-6  ">
                                                            ...
                                                            <div class="row justify-content-center">
                                                                <div class="col-3">
                                                                    <input class="form-check-input " type="radio"
                                                                        name="gender" id="gen-male" value="male">
                                                                    <label class="form-check-label"
                                                                        for="gen-male">Male</label>
                                                                </div>
                                                                <div class="col-3">
                                                                    <input class="form-check-input " type="radio"
                                                                        name="gender" id="gen-female" value="female">
                                                                    <label class="form-check-label"
                                                                        for="gen-female">Female</label>
                                                                </div>
                                                                <div class="col-3">
                                                                    <input class="form-check-input " type="radio"
                                                                        name="gender" id="gen-p" value="female">
                                                                    <label class="form-check-label"
                                                                        for="gen-others">Others</label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-md-12">
                                                        <label for="user-name">Educational Qualification(s) (Highest
                                                            to be
                                                            mentioned
                                                            first)</label>
                                                    </div>
                                                    ...
                                                    <div id="no-more-tables"
                                                        ...
                                                        <table
                                                            ...
                                                            <thead class="cf">
                                                                <tr>
                                                                    <th>Sr. No.</th>
                                                                    <th>Degree/Qualification acquired</th>
                                                                    <th>Name of college/school/institution</th>
                                                                    <th>Univ./Board</th>
                                                                    <th>Marks Obtained (% age)</th>
                                                                    <th>Year</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td data-title="Qualification acquired"><input
                                                                            type="text" name="quali-aqu1"
                                                                            class="form-control inpt" id="quali-aqu1">
                                                                    </td>
                                                                    <td data-title="Name of institution"><input
                                                                            type="text" name="coll-name1"
                                                                            class="form-control inpt" id="coll-name1">
                                                                    </td>
                                                                    <td data-title="Univ./Board"> <input type="text"
                                                                            name="univ-board1" class="form-control inpt"
                                                                            id="univ-board1"></td>
                                                                    <td data-title="Marks Obtained(%age)"><input
                                                                            type="text" name="marks1"
                                                                            class="form-control inpt" id="marks1">
                                                                    </td>
                                                                    <td data-title="Year"> <input type="text"
                                                                            name="year1" class="form-control inpt year-width "
                                                                            id="year1"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td data-title="Sr. No.">
                                                                    ...
                                                                    <td data-title="Qualification acquired"><input
                                                                            type="text" name="quali-aqu2"
                                                                            class="form-control inpt" id="quali-aqu2">
                                                                    </td>
                                                                    <td data-title="Name of institution"><input
                                                                            type="text" name="coll-name2"
                                                                            class="form-control inpt" id="coll-name2">
                                                                    </td>
                                                                    <td data-title="Univ./Board"> <input type="text"
                                                                            name="univ-board2" class="form-control inpt"
                                                                            id="univ-board2"></td>
                                                                    <td data-title="Marks Obtained(%age)"><input
                                                                            type="text" name="marks2"
                                                                            class="form-control inpt" id="marks2">
                                                                    </td>
                                                                    <td data-title="Year"> <input type="text"
                                                                            name="year2" class="form-control inpt year-width"
                                                                            id="year2"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td data-title="Sr. No.">
                                                                    ...
                                                                    <td data-title="Qualification acquired"><input
                                                                            type="text" name="quali-aqu3"
                                                                            class="form-control inpt" id="quali-aqu3">
                                                                    </td>
                                                                    <td data-title="Name ofinstitution"><input
                                                                            type="text" name="coll-name3"
                                                                            class="form-control inpt" id="coll-name3">
                                                                    </td>
                                                                    <td data-title="Univ./Board"> <input type="text"
                                                                            name="univ-board3" class="form-control inpt"
                                                                            id="univ-board3"></td>
                                                                    <td data-title="Marks Obtained(%age)"><input
                                                                            type="text" name="marks3"
                                                                            class="form-control inpt" id="marks3">
                                                                    </td>
                                                                    <td data-title="Year"> <input type="text"
                                                                            name="year3" class="form-control inpt year-width"
                                                                            id="year3"></td>
                                                                </tr>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <label class="sr-no" for="sr-no">Sr. No</label>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="sr-no" for="sr-no">Degree/Qualification acquired</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="sr-no" for="sr-no">Name college/ school/ institution</label> 
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="sr-no" for="sr-no">Univ./Board</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="sr-no" for="sr-no">Marks Obtained (% age)</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <label class="sr-no d-lg-none" for="sr-no">Sr. No</label>
                                                                <label class="sr-no" for="sr-no">10th</label>
                                                                <!-- <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1" disabled> -->
                                                            </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="sr-no d-lg-none" for="sr-no">Degree/Qualification acquired</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="sr-no d-lg-none" for="sr-no">Name college/ school/ institution</label> 
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="sr-no d-lg-none" for="sr-no">Univ./Board</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="sr-no d-lg-none" for="sr-no">Marks Obtained (% age)</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <label class="sr-no d-lg-none">Year</label>
                                                                <input type="text" name="quali-aqu1" class="form-control inpt"
                                                                id="quali-aqu1">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-6">
                                                <label for="project-det"> Details of projects
                                                    undertaken,if any
                                                    :</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="present-stat">Present Status of Projects
                                                    (Completed,
                                                    Ongoing etc.)</label>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-6">
                                                <label for="dis-int">Discipline(s) in which internship is
                                                    sought</label>
                                                <textarea id="dis-int" class="form-control mt-1" rows="3"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="rel-info">Any other relevant
                                                    information</label>
                                    ...
                                    <div class="container mt-4">
                                        <form id="form3" class="text-center">
                                            ...
                                            <div class="row m-2 p-2 justify-content-center">
                                                <div class="col-md-5" id="id3">
                                                    <label for="txtName" class="float-left ">
                                                        <b>
                                                            Government ID
                                                        </b> <b style="color:red">*</b>
                                                    </label>
                                                ...
                                                <div class="col-md-7" id="id3">
                                                    <label for="txtName" class="float-left ">
                                                        <b>
                                                            Number
                                                        </b> <b style="color:#ff0000">*</b>
                                                    </label>
                                                    <div class="input-group input-with-actions">
                                                        <input id="txtGovtId" type="text" class="form-control"
                                            ...
                                            <div class="row m-2 p-2 justify-content-center">
                                                <div class="col-md-6" id="id3">
                                                    ...
                                                    <div class="input-group input-with-actions">
                                                        <textarea id="txtName" type="text" class="form-control"
                                            ...
                                            <center>
                                                <button type="submit" id="tab-basic-info"
